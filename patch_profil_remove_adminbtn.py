...
old1 = 'const ADMIN_UID = "QFC18HxRAZabqYD85S5eA7VLC5D3";\nlet currentUser = null;'
new1 = "let currentUser = null;"
c = patch(c, old1, new1, "admin-const")

old2 = '<a href="admin.html" id="btn-admin" style="display:none;align-items:center;gap:6px;text-decoration:none;color:#0d0f16;font-size:13px;background:linear-gradient(90deg,var(--primary),var(--primary-dark));border-radius:8px;padding:8px 12px;font-weight:700;">&#9881; Admin</a>\n    <button id="btn-logout">Déconnexion</button>'
new2 = "<button id=\"btn-logout\">Déconnexion</button>"
